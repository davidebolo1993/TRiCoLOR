...
def main():
	...
	parser.add_argument("--hap1_table",default=None, help="table containing repetitions for the haplotype 1 .srt.bam window")
	parser.add_argument("--hap2_table", default=None, help="table containing repetitions for the haplotype 2 .srt.bam window")
	parser.add_argument("--label", help="label to identify the plot")
	parser.add_argument("--out", help="where to save the .html file")
	args = parser.parse_args()

	Generate_Alignment_ToPlot(args.reference_fasta,args.hap1_bam,args.hap2_bam,args.ref_table,args.hap1_table,args.hap2_table,args.label,args.out)
...
def Generate_Alignment_ToPlot(reference_fasta,hap1_bam,hap2_bam,ref_table,hap1_table,hap2_table,label,out):
	...
	bam1_coords,bam1_seq=Get_Alignment_Position(hap1_bam)
	bam1_mod_coords,bam1_mod_seq=Modifier(bam1_coords,bam1_seq)

	bam2_coords,bam2_seq=Get_Alignment_Position(hap2_bam)
