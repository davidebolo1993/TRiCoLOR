...
def main():
	...
	parser.add_argument("--hap1_table",default=None, help="haplotype 1 table containing repetitions for a certain window")
	parser.add_argument("--hap2_table", default=None, help="haplotype 2 table containing repetitions for a certain window")
