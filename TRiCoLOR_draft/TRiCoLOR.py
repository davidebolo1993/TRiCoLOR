...
def main():
	...
	try:
		...
		subprocess.call(['bcftools', 'norm', '-f', os.path.abspath(args.genome), '-o', os.path.abspath(args.output + '/TRiCoLOR.norm.vcf.gz'), os.path.abspath(args.output + '/TRiCoLOR.vcf.gz')],stderr=open(os.devnull, 'wb'))
